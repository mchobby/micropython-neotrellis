...
A Micropython driver class for interfacing clusters of 4x4 NeoTrellis with
elastomer buttons and NeoPixel RGB LEDs.

Note: almost original, it only change the reference to seesaw library
...
* MicroPython Seesaw library
  https://github.com/mchobby/micropython-seesaw
"""
...
from seesaw.keypad import KeyEvent
