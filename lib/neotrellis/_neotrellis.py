"""
``micropython-neotrellis``

A MicroPython driver class for the 4x4 NeoTrellis with elastomer buttons and
NeoPixel RGB LEDs.

Author(s): 
 - Dean Miller, JG for CedarGroveMakerStudios (CircuitPython version)
 - Meurisse D (MicroPython)
...
* Seesaw library for MicroPython : https://github.com/mchobby/micropython-seesaw
"""

__version__ = "0.0.0+auto.0"
__repo__ = "https://github.com/mchobby/micropython-neotrellis.git"

from time import sleep
from micropython import const
from seesaw.keypad import Keypad, KeyEvent
from seesaw.neopixel import NeoPixel, GRB
